	...
	public boolean addUser(UserTO user) {
		...
		if (ub.getUsername() != null) {
			...
			try {
				...
				message.setContent("<b> Hello " + name
						+ ",</b><br><h3> Please find below the Credentials of Library Management System</h3><br>"
	...
	public boolean forgot(UserTO user) {
		...
		if (ub.getUsername() == null) {
			...
			try {
				...
				message.setContent("<b> Hello " + ub.getName()
						+ ",</b><br><h3>It seems you have forgotten your password.Following is your current password:</h3><br>"
