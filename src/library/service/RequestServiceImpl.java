...
public class RequestServiceImpl extends RequestService {
	...
	public void approveRequest(int id) {
		...
		try {
			...
			message.setContent(
					"<b> Hello,</b><br><h3>> Requested Book with the following details has been added to Catalogue</h3><br>"
							+ "Book Title:-" + rto.getTitle() + "<br>" + "Book Author:-" + rto.getAuthor() + "<br>"
							+ "Book Category:-" + rto.getCategory() + "<br><br> Regards,<br>Library Admin.",
					"text/html");
