...
public class TransactionBD {
	...
	static void notifyreturn(String isbn, String uname) {
		service.notifyreturn(isbn, uname);
	}
	...
	private static TransactionBean TO2Bean(TransactionTO bkt) {
		TransactionBean request = new TransactionBean(bkt.getTransactionId(), bkt.getUsername(), bkt.getISBN(),
				bkt.getIssuedate(), bkt.getDuedate(), bkt.getFine());
		return request;
	}
