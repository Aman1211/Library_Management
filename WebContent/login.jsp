                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <input type="hidden" name="action" value="loginvalidate">
                            ...
                            <div>
                             <p> <span style="color:red"><%=(session.getAttribute("user") == null) ? ""
                              : "Welcome " + session.getAttribute("user")%></span></p>
                             </div>
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary">
                                    Sign in
                                </button>
                                <a href="<%= application.getContextPath() %>/Controller?action=forgot" class="btn btn-link">
