	 ...
	 %>
                        ...
                        <input type="hidden" name="uname" value=<%=ub.getUsername() %>>
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="username" value=<%=ub.getUsername() %> class="form-control" name="username" autofocus>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="name" value="<%=ub.getName() %>" class="form-control" name="name" >
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="contact" class="col-md-4 col-form-label text-md-right">Contact*</label>
                                <div class="col-md-6">
                                    <input type="number" id="contact" value="<%=ub.getContact() %>" class="form-control" name="contact"  autofocus>
                                </div>
                            </div>
