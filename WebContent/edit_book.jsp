	 ...
	 %>
                        ...
                        <input type="hidden" name="action" value="editbookvalidate">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="title" value="<%=bb.getTitle() %>" class="form-control" name="title" >
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="Author" class="col-md-4 col-form-label text-md-right">Author Name*</label>
                                <div class="col-md-6">
                                    <input type="text" id="aname" value="<%=bb.getAuthor() %>" class="form-control" name="aname"  autofocus>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="qty" class="col-md-4 col-form-label text-md-right">Quantity of books*</label>
                                <div class="col-md-6">
                                    <input type="number" id="qty" value="<%=bb.getQty() %>" class="form-control" name="qty"  autofocus>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="number" id="qty" value="<%=bb.getRack() %>" class="form-control" name="rno"  autofocus>
                                </div>
                            </div>
