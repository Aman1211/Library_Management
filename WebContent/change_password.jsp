						...
						<div class="card-body">
							<form action="Controller" method="post">
								<input type="hidden" name="action"
									value="changepasswordvalidate">
								<div class="form-group row" hidden>
									<label for="email_address"
										class="col-md-4 col-form-label text-md-right">Username*</label>
									<div class="col-md-6">
										<input type="text" id="username" class="form-control"
											value="<%=session.getAttribute("user")%>" name="username"
											autofocus>
									</div>
								</div>
								<div class="form-group row">
									<label for="password"
										class="col-md-4 col-form-label text-md-right">Currrent
										Password*</label>
									<div class="col-md-6">
								...
								<div class="col-md-6 offset-md-4">
									<p>
										<span style="color: red"><%=(request.getAttribute("errMessage1") == null) ? "" : request.getAttribute("errMessage1")%></span>
									</p>
								</div>
